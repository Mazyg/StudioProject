...
public class TelephoneUtil {
    ...
    //配置您申请的KEY(在我的接口里面)
    public static final String APPKEY ="62ff8651334736a77b735c919fa1d314";
    ...
    //2.发送短信
    public static int getRequest2(String telephone){
        Random random = new Random();
        int num = random.nextInt(9000) + 1000;//生成一个四位的随机数

        String result =null;
        String url ="http://v.juhe.cn/sms/send";//请求接口地址
        Map params = new HashMap();//请求参数
        params.put("mobile", telephone);//接收短信的手机号码
        params.put("tpl_id","214649");//短信模板ID，请参考个人中心短信模板设置
