            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <p class="card-description"> 评论列表</p>
                                <table class="table table-hover">
                                    ...
                                    <c:forEach var="comment" items="${comments}">
                                        <tr>
                                            ...
                                            <td>${comment.uname}</td>
                                            <td>${comment.rname}</td>
                                            <p id="wid" style="display: none">${comment.wid}</p>
                                            <td><a href="javascript:void(0)" style="color: orangered" class="deleteComment">删除评论</a></td>
        ...
        $(".deleteComment").click(function () {
            ...
            $.ajax({
                ...
                success:function (result) {
                    if (result == "success"){
                        alert("删除成功");
                        window.location.href = "../dynamic/findAllReplyByWid.do?wid="+$wid;
                    }else {
                        alert("删除失败");
                    }
                }
