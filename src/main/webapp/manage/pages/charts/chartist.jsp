      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="chartist.jsp">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="../samples/error-404.jsp"> 404 </a></li>
                  <li class="nav-item"> <a class="nav-link" href="../samples/error-500.jsp"> 500 </a></li>
                  <li class="nav-item"> <a class="nav-link" href="../samples/blank-page.jsp"> Blank Page </a></li>
                </ul>
              </div>
            </li>
