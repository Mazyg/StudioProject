            ...
            <div class="pager">
                ...
                <c:choose>
                    <c:when test="${pageInfo.pageNum>1}">
                        <a href="../info/findEvent.do?pageNum=${pageInfo.prePage}" rel="external nofollow" ><<</a>
                    </c:when>
                    <c:otherwise>
                        <a><<</a>
                    </c:otherwise>
                ...
                <c:forEach items="${pageInfo.navigatepageNums}" var="page">
                    <a href="../info/findEvent.do?pageNum=${page}" rel="external nofollow" rel="external nofollow" rel="external nofollow" class="currentPage">${page}</a>
                </c:forEach>

                <!-- 下一页 按钮 -->
                <c:choose>
                    <c:when test="${pageInfo.hasNextPage}">
                        <a href="../info/findEvent.do?pageNum=${pageInfo.nextPage}" rel="external nofollow">
                            >>
                        </a>
                    </c:when>
                    <c:otherwise>
