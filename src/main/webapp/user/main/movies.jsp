...
<header class="clearfix">
    <section class="mainWrap">
        <div class="topwraper relative clearfix">
            <div class="search">
                <input name="query" id="search" autocomplete="off"/>
                ...
                <li class="clearfix">
                    <figure>
                        <a class="picwraper"  target="_blank">
                            <img data-original="${movie.photo}" src="img/loading.gif">
                        </a>
            ...
            <div class="pager">
                ...
                <c:choose>
                    <c:when test="${pageInfo.pageNum>1}">
                        <a href="../info/findMovies.do?pageNum=${pageInfo.prePage}" rel="external nofollow" ><<</a>
                    </c:when>
                    <c:otherwise>
                        <a><<</a>
                    </c:otherwise>
                ...
                <c:forEach items="${pageInfo.navigatepageNums}" var="page">
                    <a href="../info/findMovies.do?pageNum=${page}" rel="external nofollow" rel="external nofollow" rel="external nofollow" class="currentPage">${page}</a>
                </c:forEach>

                <!-- 下一页 按钮 -->
                <c:choose>
                    <c:when test="${pageInfo.hasNextPage}">
                        <a href="../info/findMovies.do?pageNum=${pageInfo.nextPage}" rel="external nofollow">
                            >>
                        </a>
                    </c:when>
                    <c:otherwise>
            ...
            <section class="mod withborder">
                ...
                <table class="table newslist clearfix">
                    <c:forEach items="${videoInfo}" var="videoList">
                        <tr>
                            <td><a href="../info/findByIdInfo.do?infoId=${videoList.info_id}"><img class="imgs1" data-original="${videoList.photo}" src="img/loading.gif"></a></td>
